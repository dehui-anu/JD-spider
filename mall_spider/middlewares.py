...
#在middlewares中，实现 random user agent类

class RandomUserAgent(object):
    def process_request(self, request, spider):#实现process request方法
        #如果是请求是 https://cdnware.m.jd.com 开头的, 就是设置一个iPhone的user-agent
...
class ProxyMiddleware(object):
    ...
    def process_exception(self, request, exception, spider):#数据异常时
